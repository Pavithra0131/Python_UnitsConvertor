...
# ==== Type 8 (Area) ====
    ...
    # ==== converting ====
    if Area_convert == 1:
        print("{} Sqft is equal to {} Sqmtrs".format(Area_value, Area_value /10.764))
    elif Area_convert == 2:
        print("{} Sqft is equal to {} Acres".format(Area_value, Area_value /43560))
    elif Area_convert == 3:
        print("{} Sqft is equal to {} Hectes".format(Area_value, Area_value /107639.104))
    else:
        print("Sorry, Please type correct number from 1 to 3.")
